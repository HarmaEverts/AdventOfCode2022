...
def pair_overlaps(elf_pair):
    ...
    if elf1_range.start in elf2_range or elf1_range[-1] in elf2_range:  # Range 1 contains range 2
        return True
    elif elf2_range.start in elf1_range or elf2_range[-1] in elf1_range:  # Range 2 contains range 1
        return True
    else:
        return False
